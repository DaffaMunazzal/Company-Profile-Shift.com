...
const STOCK_BADGE = {
  "in-stock": { label: "Ready to Ship", modifier: "product-card__badge--green" },
  limited: { label: "Limited Stock", modifier: "product-card__badge--orange" },
  "pre-order": { label: "Pre-order", modifier: "product-card__badge--blue" },
  "out-of-stock": { label: "Out of Stock", modifier: "" },
};
      ...
      <div className="product-card__media">
        ...
        {isOutOfStock ? (
          <div className="product-card__overlay">
            <span className="product-card__overlay-label">Out of Stock</span>
          </div>
        ) : (
          <div className="product-card__stock-badge">
            <span className={`product-card__badge-dot ${badge.modifier}`} />
        ...
        <div className="product-card__quick-actions">
          ...
          <button type="button" aria-label="Bandingkan produk" className="product-card__icon-btn">
